//import UIKit
//
//final class NEWPlaceDetailController: UITableViewController, LoadableViewController {
//  
//    var state: LoadingState
//    
//    private let viewModel: DetailsViewModel
//    private let coordinator: DetailCoordinatable
//    private let stateController: StateChangeHandling
//    
...
//            state = .failed(error: CustomError(title: Constants.noInternetConnectionTitle,
//                                               message: Constants.noInternetConnetionMessage))
//            stateController.stateChanged(to: state)
//            return
//        }
//        fetchData()
//    }
