...
protocol NEWSearchTabCoordinatable:  Coordinator, SearchCoordinatable, DetailCoordinatable {}

class NEWSearchTabCoordinator: NEWSearchTabCoordinatable {
    ...
    func start() {
        let searchController = SearchController(coordinator: self)
